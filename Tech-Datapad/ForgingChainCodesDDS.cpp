...
public:
    void drawForgingChainCodes(MCUFRIEND_kbv &tftlcd)
    {
        ...
        int16_t steps = 50;
        const char *paragrahp1[] PROGMEM = FORGING_CHAIN_CODES_FIRST_PARAGRAPH_VALUES;
        ...
        textPrinter1.clear();
        const char *paragrahp2[] PROGMEM = FORGING_CHAIN_CODES_SECOND_PARAGRAPH_VALUES;
        ...
        textPrinter2.clear();
        const char *paragrahp3[] PROGMEM = FORGING_CHAIN_CODES_THIRD_PARAGRAPH_VALUES;
        ...
        textPrinter3.clear();
        const char *paragrahp4[] PROGMEM = FORGING_CHAIN_CODES_FOURTH_PARAGRAPH_VALUES;
        ...
        textPrinter4.clear();
        const char *paragrahp5[] PROGMEM = FORGING_CHAIN_CODES_FIFTH_PARAGRAPH_VALUES;
