...
DatapadActionSetup::DatapadActionSetup(MCUFRIEND_kbv &tftlcd, uint8_t smallWhiteButtonPin, uint8_t redButtonPin, uint8_t whiteButtonPin, uint8_t yellowButtonPin) : _tftlcd(tftlcd), _smallWhiteButtonPin(smallWhiteButtonPin), _redButtonPin(redButtonPin), _whiteButtonPin(whiteButtonPin), _yellowButtonPin(yellowButtonPin)
{
}
